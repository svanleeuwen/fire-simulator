...
SOURCES       = main.cpp \
		...
		spectrum.cpp \
		colourUtil.cpp \
		s_grid.cpp moc_paintwindow.cpp \
		moc_paintcanvas.cpp
OBJECTS       = main.o \
		paintwindow.o \
		paintcanvas.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/fire1.0.0/ && $(COPY_FILE) --parents paintwindow.hpp paintcanvas.hpp grid.hpp v_grid.hpp q_grid.hpp mac_grid.hpp level_set.hpp t_grid.hpp spectrum.hpp colourUtil.hpp s_grid.hpp .tmp/fire1.0.0/ && $(COPY_FILE) --parents main.cpp paintwindow.cpp paintcanvas.cpp grid.cpp v_grid.cpp q_grid.cpp mac_grid.cpp level_set.cpp t_grid.cpp spectrum.cpp colourUtil.cpp s_grid.cpp .tmp/fire1.0.0/ && (cd `dirname .tmp/fire1.0.0` && $(TAR) fire1.0.0.tar fire1.0.0 && $(COMPRESS) fire1.0.0.tar) && $(MOVE) `dirname .tmp/fire1.0.0`/fire1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/fire1.0.0
