#############################################################################
# Makefile for building: smoke
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  smoke.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile smoke.pro
#############################################################################
...
SOURCES       = main.cpp \
		...
		v_grid.cpp \
		q_grid.cpp \
		mac_grid.cpp moc_paintwindow.cpp \
		moc_paintcanvas.cpp
OBJECTS       = main.o \
		paintwindow.o \
		paintcanvas.o \
...
Makefile: smoke.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/smoke1.0.0 || mkdir -p .tmp/smoke1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/smoke1.0.0/ && $(COPY_FILE) --parents paintwindow.hpp paintcanvas.hpp grid.hpp v_grid.hpp q_grid.hpp mac_grid.hpp .tmp/smoke1.0.0/ && $(COPY_FILE) --parents main.cpp paintwindow.cpp paintcanvas.cpp grid.cpp v_grid.cpp q_grid.cpp mac_grid.cpp .tmp/smoke1.0.0/ && (cd `dirname .tmp/smoke1.0.0` && $(TAR) smoke1.0.0.tar smoke1.0.0 && $(COMPRESS) smoke1.0.0.tar) && $(MOVE) `dirname .tmp/smoke1.0.0`/smoke1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/smoke1.0.0
